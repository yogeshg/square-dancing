...
public class Player implements sqdance.sim.Player {
	...
	// remainingEnjoyment[i][j]: the remaining enjoyment player j can give
	// player i
	...
	// Preserve signature of this function as the same as play() - FIXME why are
	// we doing this?
